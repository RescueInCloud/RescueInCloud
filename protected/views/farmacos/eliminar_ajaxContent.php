...
<table class="table table-hover table-bordered">
    ...
    <ul class="pagination pagination-sm">
        ...
        <?php
            ...
            if($pag_actual!=1){
        ?>
                <li><a href="<?php echo Yii::app()->createUrl('/farmacos/paginarEliminar/'.($pag_actual-1))?>">Anterior</a></li>
        <?php
            }
        ...
        ?>
                    ...
                    ?>
                        <li><a href="<?php echo Yii::app()->createUrl('/farmacos/paginarEliminar/'.$num_pag)?>">
                            <?php echo $num_pag ?>
                            </a>
                        </li>
                    <?php
        ...
        ?>
                <li><a href="<?php echo Yii::app()->createUrl('/farmacos/paginarEliminar/'.($pag_actual+1))?>">Siguiente</a></li>
        <?php
            }
        ?>
    </ul>