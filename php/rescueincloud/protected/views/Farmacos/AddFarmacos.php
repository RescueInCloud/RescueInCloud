...
<?php echo CHtml::beginForm('','post', array("id"=>"form","name"=>"form")); ?>
    ...
    <p>
        [Ejemplo en tabla test. 
        Lo ideal es detectar el usuario activo e insertar el fármaco nuevo y la relacion fármaco-usuario.]
    </p>
    <p>
    ...
    <p>
        Forma de presentacion del farmaco: <?php echo CHtml::activeTextField($model,'no_presentacion'); echo CHtml::error($model,'no_presentacion'); ?>
    </p>
    <p>
        Tipo de administracion: <?php echo CHtml::activeTextField($model,'no_administracion'); echo CHtml::error($model,'no_administracion'); ?>
    </p>
    <p>
