...
--
-- Servidor: localhost
-- Tiempo de generación: 01-12-2013 a las 19:34:54
-- Versión del servidor: 5.1.41
-- Versión de PHP: 5.3.1

--
-- Versión autoincremental del índice de la tabla de fármacos (farmacos_V2)
--
...
--
-- Estructura de tabla para la tabla `farmacos_v2`
--

CREATE TABLE IF NOT EXISTS `farmacos_v2` (
  `id_farmaco` int(11) NOT NULL AUTO_INCREMENT,
  `email_usuario` varchar(100) COLLATE latin1_bin NOT NULL,
  `nombre_farmaco` varchar(100) COLLATE latin1_bin NOT NULL,
  `nombre_fabricante` varchar(100) COLLATE latin1_bin NOT NULL,
  `nombre_quimico` varchar(100) COLLATE latin1_bin NOT NULL,
  `creado_en` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modificado_en` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `descripcion_farmaco` varchar(500) COLLATE latin1_bin NOT NULL DEFAULT 'Default Description',
  `borrado` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_farmaco`,`email_usuario`),
  KEY `email_usuario` (`email_usuario`)
...
--
-- Volcar la base de datos para la tabla `farmacos_v2`
--

INSERT INTO `farmacos_v2` (`id_farmaco`, `email_usuario`, `nombre_farmaco`, `nombre_fabricante`, `nombre_quimico`, `creado_en`, `modificado_en`, `descripcion_farmaco`, `borrado`) VALUES
(1, 'ale7jandra.89@gmail.com', 'Paracetamol', 'Cinfa', 'Acetaminofén', '2013-12-01 19:10:53', '0000-00-00 00:00:00', 'Farmaco Paracetamol', 0),
(2, 'ale7jandra.89@gmail.com', 'Aspirina', 'Bayer', 'Ácido acetilsalicílico', '2013-12-01 19:16:28', '0000-00-00 00:00:00', 'Farmaco Aspirina', 0),
(3, 'ale7jandra.89@gmail.com', 'Gelocatil', 'Laboratorios Gelos', 'Paracetamol', '2013-12-01 19:22:32', '0000-00-00 00:00:00', 'Principio activo de Gelocatil: Paracetamol', 0);
